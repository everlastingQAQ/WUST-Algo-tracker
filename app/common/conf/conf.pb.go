...
const file_app_common_conf_conf_proto_rawDesc = "" +
	...
	"\x04smtp\x18\x04 \x01(\v2\x10.kratos.api.SMTPR\x04smtp\"\xec\x02\n" +
	"\x06Server\x12+\n" +
	...
	"\x04from\x18\x05 \x01(\tR\x04fromB'Z%cwxu-algo/app/user/internal/conf;confb\x06proto3"
...
var file_app_common_conf_conf_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
