...
func RegisterBulletinHTTPServer(s *http.Server, srv BulletinHTTPServer) {
	...
	r.POST("/v1/core/bulletin/update", _Bulletin_Update0_HTTP_Handler(srv))
...
func _Bulletin_Update0_HTTP_Handler(srv BulletinHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
